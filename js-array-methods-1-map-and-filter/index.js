...
console.log(JSON.stringify(recipesThatOnlyTake60minutesOrLess));

const allRecipesWithMoreThan2Servings = recipes.filter(
  (recipe) => recipe.servings > 2,
);
console.log(JSON.stringify(allRecipesWithMoreThan2Servings));

const allRecipesWithTitlesLongerThan12Characters = recipes.filter(
  (recipe) => recipe.title.length > 12,
);
console.log(JSON.stringify(allRecipesWithTitlesLongerThan12Characters));
